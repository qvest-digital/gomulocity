...
func TestMeasurementApi_NextPage_Success(t *testing.T) {
	...
	expectedUrl := ts.URL + "/measurement/measurements?source=1111111&pageSize=5&currentPage=3"
...
func TestMeasurementApi_PreviousPage_Success(t *testing.T) {
	...
	expectedUrl := ts.URL + "/measurement/measurements?source=1111111&pageSize=5&currentPage=1"
	collection := createCollection("", expectedUrl)
